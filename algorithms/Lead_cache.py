...
from algorithms.LPsolver import SolveLP
from algorithms.rounding import cache_by_cache_pipage_rounding
from algorithms.rounding_madow import madow_rounding
...
def Lead_cache(cache_request, Adj, T, F, C, d):
    ...
    return hit_rate, download_rate, hit_rate_Madow, download_rate_Madow
